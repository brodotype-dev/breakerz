          ...
          <div className="flex flex-col">
            ...
            <ElevatedCard className="flex-1">
              ...
              {result && !running ? (
                ...
                <div className="rounded-lg p-12 h-full min-h-[280px] flex items-center justify-center border" style={{ borderColor: 'var(--terminal-border)' }}>
